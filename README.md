...
В данном проекте были рассмотрены основные этапы очистки данных, а именно работа с пропущенными значениями, очистка данных от пропусков и удаление признаков и записей, которые не несут полезной информации. Целью очистки данных является избавление от "мусора", который может исказить результаты моделирования.